          ...
          if (containsDate) {
            for (const item of chain.data) {
              if (
                ...
                avgEpochsNumber.push(item.avgEpochsNumber);
              }
            }
          } else {
            avgEpochsNumber.push(null);
          }
        }
      ...
      >
        ...
        <Flex w="100%" flexDirection={{ base: "column", lg: "row" }}>
          <Flex flexDirection="column" me="20px" mt="28px">
            ...
            >
              {button === ""
                ? total_pubs.avgEpochsNumber >= 1000000
                  ? (total_pubs.avgEpochsNumber / 1000000).toFixed(2) + "M"
                  : total_pubs.avgEpochsNumber >= 1000
                  ? (total_pubs.avgEpochsNumber / 1000).toFixed(2) + "K"
                  : total_pubs.avgEpochsNumber.toFixed(2)
                : last_pubs.avgEpochsNumber >= 1000000
                ? (last_pubs.avgEpochsNumber / 1000000).toFixed(2) + "M"
                : last_pubs.avgEpochsNumber >= 1000
                ? (last_pubs.avgEpochsNumber / 1000).toFixed(2) + "K"
                : last_pubs.avgEpochsNumber.toFixed(2)}
            </Text>
